    ...
    <div className="space-y-6">
      <Card>
        ...
        <CardContent className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-500 mt-1">
                  ...
                  created in your iCloud address book. When disabled, new
                  contacts are stored locally only.
                </p>
              </div>
              <Switch
                id="create-on-icloud"
          ...
          {/* Sync mode when connecting iCloud */}
              ...
              <label className="flex items-start gap-3 p-4 border rounded-lg cursor-pointer hover:bg-gray-50">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    ...
                    This will add your local contacts to your iCloud
                    address book.
                  </p>
                </div>
              </label>
              ...
              <label className="flex items-start gap-3 p-4 border rounded-lg cursor-pointer hover:bg-gray-50">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    ...
                    iCloud contacts. Your iCloud address book will become
                    the source of truth.
                  </p>
                </div>
              </label>
